...
Response.fromURL = function() {
    //only want to save the openid. fields
    //so parse out all the ones with openid.
    //then run it through the util
    //and put the results in a new Response()
    //return the new response
    //test both functions fromForm() and fromURL()
}
